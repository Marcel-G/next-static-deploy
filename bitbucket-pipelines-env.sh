...
eval BUCKET_NAME=\$BUCKET_NAME_$BRANCH
eval CLOUDFRONT_DISTRIBUTION_ID=\$CLOUDFRONT_DISTRIBUTION_ID_$BRANCH
eval AWS_ACCESS_KEY_ID=\$AWS_ACCESS_KEY_ID_$BRANCH
eval AWS_SECRET_ACCESS_KEY=\$AWS_SECRET_ACCESS_KEY_$BRANCH
